...
export const translations: Record<Locale, TranslationDict> = {
  pt: {
    ...
    exchangeSubtitle: 'Deixe seus dados e eu salvo seu contato no celular. Você recebe o meu de volta.',
    exchangeName: 'Nome',
    ...
    exchangeSuccess: 'Contato enviado! Obrigado. 🙌',
  ...
  en: {
    ...
    exchangeSubtitle: "Leave your details and I'll save your contact on my phone. You'll get mine back.",
    exchangeName: 'Name',
    ...
    exchangeSuccess: 'Contact sent! Thank you. 🙌',
  ...
  es: {
    ...
    exchangeSubtitle: 'Deja tus datos y guardo tu contacto en el móvil. Recibirás el mío de vuelta.',
    exchangeName: 'Nombre',
    ...
    exchangeSending: 'Enviando…',
    exchangeSuccess: '¡Contacto enviado! Gracias. 🙌',
  ...
  it: {
    ...
    exchangeSubtitle: 'Lascia i tuoi dati e salvo il tuo contatto sul telefono. Riceverai il mio in cambio.',
    exchangeName: 'Nome',
    ...
    exchangeSuccess: 'Contatto inviato! Grazie. 🙌',
